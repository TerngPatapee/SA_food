...
function NutritionistCreate() {
  ...
  const [nutritionist, setNutritionist] = useState<Partial<NutritionistsInterface>>({});
  ...
  const handleInputChange = (
    ...
    const id = event.target.id as keyof typeof nutritionist;
    ...
    <Container className={classes.container} maxWidth="md">
      ...
      <Paper className={classes.paper}>
        ...
        <Grid container spacing={3} className={classes.root}>
          ...
          <Grid item xs={12}>
            <Button component={RouterLink} to="/nutritionists" variant="contained">
              กลับ
            </Button>
            <Button
              style={{ float: "right" }}
